...
cfg.CONF.register_opts([
    ...
    cfg.IntOpt('quota-zones', default=10000,
               help='Number of zones allowed per tenant'),
    cfg.IntOpt('quota-zone-recordsets', default=500000,
               help='Number of recordsets allowed per zone'),
    cfg.IntOpt('quota-zone-records', default=500000,
               help='Number of records allowed per zone'),
    cfg.IntOpt('quota-recordset-records', default=2000,
               help='Number of records allowed per recordset'),
    cfg.IntOpt('quota-api-export-size', default=100000,
