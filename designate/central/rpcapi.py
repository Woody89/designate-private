...
class CentralAPI(object):
    ...
    def create_acl(self, context, acl):
        return self.client.call(context, 'create_acl', acl=acl)

    def create_zdns_acl(self, context, acl, response):
        return self.client.call(context, 'create_zdns_acl', acl=acl, response=response)

    def get_acl(self, context, acl_id):
        return self.client.call(context, 'get_acl',
                                acl_id=acl_id)

    def find_acls(self, context, criterion=None, marker=None, limit=None,
                      sort_key=None, sort_dir=None):
        return self.client.call(context, 'find_acls', criterion=criterion,
                                marker=marker, limit=limit, sort_key=sort_key,
                                sort_dir=sort_dir)

    def update_acl(self, context, acl):
        return self.client.call(context, 'update_acl', acl=acl)

    def update_zdns_acl(self, context, acl, values):
        return self.client.call(context, 'update_zdns_acl', acl=acl,
                                values=values)

    def delete_acl(self, context, acl_id):
        return self.client.call(context, 'delete_acl',
                                acl_id=acl_id)

    def delete_zdns_acl(self, context, acl):
        return self.client.call(context, 'delete_zdns_acl', acl=acl)
    ...
    def create_zdns_zone(self, context, zone, response):
        return self.client.call(context, 'create_zdns_zone', zone=zone, response=response)
    ...
    def update_zdns_zone(self, context, zone, response):
        return self.client.call(context, 'update_zdns_zone', zone=zone,
                                response=response
                                )
    ...
    def delete_zdns_zone(self, context, zone):
        return self.client.call(context,'delete_zdns_zone',zone=zone)
    ...
    def get_record_association(self, context, record_id):
        return self.client.call(context, 'get_record_association', record_id=record_id)
    
    def get_zdns_record(self, context, zdns_record_id):
        return self.client.call(context, 'get_zdns_record', zdns_record_id=zdns_record_id)
    ...
    def create_zdns_record(self, context, zone, zdns_record):
        return self.client.call(context, 'create_zdns_record',
                                zone=zone,
                                zdns_record=zdns_record)

    def update_recordset_callback(self, context, zone, recordset):
        return self.client.call(context, 'update_recordset_callback',
                                zone=zone,
                                recordset=recordset)
    
    def update_zdns_record(self, context, zdns_record):
        return self.client.call(context, 'update_zdns_record',
                                zdns_record=zdns_record)
    ...
    def update_status(self, context, zone_id, status, serial):
        self.client.call(context, 'update_status', zone_id=zone_id,
                         status=status, serial=serial)

    def update_zone_status(self, context, zone):
        self.client.call(context, 'update_zone_status', zone=zone)

    def update_recordset_status(self, context, recordset, action, status):
        self.client.call(context, 'update_recordset_status', recordset=recordset,
                         action=action, status=status)
        
    def update_record_status(self, context, record, action, status):
        self.client.call(context, 'update_record_status', record=record,
                         action=action, status=status)
    ...
    def create_view(self, context, view, acl_ids):
        return self.client.call(context, 'create_view', view = view,
                                acl_ids = acl_ids)
    
    def delete_view(self, context, view_id):
        return self.client.call(context, 'delete_view', view_id = view_id)

    def get_view(self, context, view_id):
        return self.client.call(context, 'get_view',view_id=view_id)
    
    def find_views(self, context, criterion=None, marker=None, limit=None,
                   sort_key=None, sort_dir=None):
        return self.client.call(context, 'find_views', criterion=criterion,
                                marker=marker, limit=limit, sort_key=sort_key,
                                sort_dir=sort_dir)
    
    def find_view_acls(self, context, view_id):
        return self.client.call(context, 'find_view_acls', view_id = view_id)

    def update_view(self, context, id, acl_ids):
        return self.client.call(context, 'update_view',
                                id=id, acl_ids = acl_ids)
    
    def create_zdns_view_info(self, context, zdns_view_info, view):
        return self.client.call(context, 'create_zdns_view_info', 
                                zdns_view_info = zdns_view_info,view = view)
        
    def update_zdns_view_info(self, context, zdns_view_info, view):
        return self.client.call(context, 'update_zdns_view_info',
                                zdns_view_info = zdns_view_info,
                                view = view)
        
    def delete_zdns_view_info(self, context, view):
        return self.client.call(context, 'delete_zdns_view_info', 
                                view = view)