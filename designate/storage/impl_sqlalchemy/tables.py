...
acls = Table('acl', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('pool_id', UUID, default=None, nullable=True),
    Column('tenant_id', UUID, default=None, nullable=True),
    Column('networks', String(255), nullable=False, unique=True),
    Column('name', String(255), nullable=False, unique=True),

    ForeignKeyConstraint(['pool_id'], ['pools.id'], ondelete='SET NULL'),

    mysql_engine='InnoDB',
    mysql_charset='utf8',
)

zdns_acls = Table('zdns_acl_info_t', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('networks', String(255), nullable=False),
    Column('name', String(255), nullable=False),
    Column('current_users', String(255), nullable=False),
    Column('href', String(255), nullable=False),
    Column('comment', String(1024), nullable=True),
    #Column("acl_id", UUID, default=1, nullable=False),

    mysql_engine='InnoDB',
    mysql_charset='utf8',
)

acl_associations = Table('acl_zdns_acl_associations', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column("acl_id", UUID, default=1, nullable=False),
    Column("zdns_acl_id", UUID, default=1, nullable=False),

    mysql_engine='InnoDB',
    mysql_charset='utf8',
)

view_acl = Table('view_acl_associations', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('view_id', UUID, default=1,nullable=False),
    Column('acl_id', UUID, default=1, nullable=False),
    mysql_engine='InnoDB',
    mysql_charset='utf8',
     )
...
zones = Table('zones', metadata,
    ...
    Column('pool_id', UUID, default=None, nullable=True),
    Column('view_id', UUID, default=None, nullable=True),
...
zdns_zones = Table('zdns_zones_info_t', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('name', String(255), nullable=False),
    Column('owners', String(255), nullable=False),
    Column('current_users', String(255), nullable=True),
    Column("slaves", String(255), nullable=False),
    Column('renewal', String(32), default='no'),
    Column('default_ttl', String(255), nullable=True),
    Column('zone_content', String(255), nullable=False),
    # The refresh interval is randomized by _generate_soa_refresh_interval
    Column('masters', String(255), default=None,
           nullable=False),
    Column('ad_controller', String(255), default=None, nullable=False),
    Column('comment', String(255), default=None, nullable=False),
    Column('rrs', String(255), default=None,
           nullable=False),
...
zone_associations = Table('zones_zdns_zone_associations', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('zone_id', UUID, default=1, nullable=False),
    Column('zdns_zone_id', UUID, default=1, nullable=False),
    mysql_engine='InnoDB',
    mysql_charset='utf8',
)
...
recordsets = Table('recordsets', metadata,
    ...
    Column('zone_id', UUID, nullable=False),
    Column('name', String(255), nullable=False),
#     Column('rr_id', String(255), nullable=False),
...
zdns_record = Table('zdns_record_info_t', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('name', String(255), nullable=False),
    Column('rr_id', String(255), nullable=False),
    Column('type', Enum(name='record_types', *RECORD_TYPES), nullable=False),
    Column('ttl', Integer, default=None, nullable=True),
    Column('rdata', String(255), nullable=False),
...
record_association = Table('records_zdns_record_associations', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('record_id', String(255), nullable=False),
    Column('zdns_record_id', String(255), nullable=False),
...
view = Table('view', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('tenant_id', String(36), default='', nullable=True),
    Column('name', String(255), nullable=False),
    Column('pool_id', UUID, default=None, nullable=False),
    ForeignKeyConstraint(['pool_id'],['pools.id'],ondelete='SET NULL'),
...
zdns_view_info_t = Table('zdns_view_info_t', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('name', String(255), nullable=False),
    Column('dns64s', String(255), nullable=True),
    Column('owners', String(255), nullable=True),
    Column('fail_forwarder', String(255), nullable=True),
    Column('current_users', String(255), nullable=True),
    Column('priority', Integer, nullable=True),
    Column('query_source', String(255), nullable=True),
    Column('href', String(255), nullable=True),
    Column('zones', String(255), nullable=True),
    Column('comment', String(1024), nullable=True),
...
view_zdns_view_associations = Table('view_zdns_view_associations', metadata,
    Column('id', UUID, default=utils.generate_uuid, primary_key=True),
    Column('view_id', UUID, default=1,nullable=False),
    Column('zdns_view_id', UUID, default=1, nullable=False),
    mysql_engine='InnoDB',
    mysql_charset='utf8',
)
