...
class Storage(DriverPlugin):
    ...
    def create_acl(self, context, acl):
        ...
        :param context: RPC Context.
        :param acl: Zone object with the values to be created.
        """

    @abc.abstractmethod
    def find_acls(self, context, criterion=None,
                      marker=None, limit=None, sort_key=None, sort_dir=None):
        """
        Find TSIG Keys.
    ...
    def delete_acl(self, context, acl_id):
        ...
        :param context: RPC Context.
        :param acl_id: Delete a TSIG Key via ID
        """
    @abc.abstractmethod
